...
@section('page-title', 'Processing Orders Page')
@section('root-title', ' Orders page ')
@section('large-title', 'Processing Orders')
        ...
        <div class="container-sm">
            <div class="card card-dark">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-users mr-2"></i>All Processing Orders</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                            ...
                                            <td style="text-align: center;">
                                                <div class="row">
                                                    <div class="col"><a class="btn btn-primary"
                                                                        href="{{ route('orders.convertOrder', ['id' => $order->id]) }}"><i
                                                                class="fas fa-retweet"></i></a></div>
                                                    <div class="col"><a class="btn btn-danger"
                                                                        href="{{ route('orders.delete-processing-order') }}"><i
                                    ...
                                    @empty
                                        <tr class="odd">
                                            <td colspan="6">Not Found any pending orders or processed.</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
